...
class Lesson8RunSimpleTest {

    @Test
    void buildShellCommandUsesBashOnLinux() {
        assertEquals(
                List.of("bash", "-lc", "pwd && ls -la"),
                Lesson8RunSimple.buildShellCommand("pwd && ls -la", false)
        );
    }
    ...
    void resolveWorkspacePathKeepsAbsoluteWorkspacePath() {
        ...
        Path resolved = Lesson8RunSimple.resolveWorkspacePath(
                workDir,
